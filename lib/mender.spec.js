...
it('should getAuthDevices()', function (done) {

    var page = 87105;
    var per_page = 84136;

    (0, _nock2.default)('https://docker.mender.io/api/management/v1/devauth').get('/devices').query({
        page: page, per_page: per_page
    }).reply(200, []);
    mender.getAuthDevices(page, per_page).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should postAuthDevices()', function (done) {

    (0, _nock2.default)('https://docker.mender.io/api/management/v1/devauth').post('/devices').query({}).reply(200, {});
    mender.postAuthDevices().then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should getAuthDevicesById()', function (done) {

    var id = "Seth.White47";

    (0, _nock2.default)('https://docker.mender.io/api/management/v1/devauth').get('/devices/' + id).query({}).reply(200, {});
    mender.getAuthDevicesById(id).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should deleteAuthDevicesById()', function (done) {

    var id = "Malcolm.Toy93";

    (0, _nock2.default)('https://docker.mender.io/api/management/v1/devauth').delete('/devices/' + id).query({}).reply(200, {});
    mender.deleteAuthDevicesById(id).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should deleteAuthDevicesByIdAuthByAid()', function (done) {

    var id = "Uriah99";
    var aid = "Gabe.Schimmel16";

    (0, _nock2.default)('https://docker.mender.io/api/management/v1/devauth').delete('/devices/' + id + '/auth/' + aid).query({}).reply(200, {});
    mender.deleteAuthDevicesByIdAuthByAid(id, aid).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should putAuthDevicesByIdAuthByAidStatus()', function (done) {

    var id = "Janice_Bogan97";
    var aid = "Betty_Schroeder";

    (0, _nock2.default)('https://docker.mender.io/api/management/v1/devauth').put('/devices/' + id + '/auth/' + aid + '/status').query({}).reply(200, {});
    mender.putAuthDevicesByIdAuthByAidStatus(id, aid).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should getAuthDevicesCount()', function (done) {

    var status = "Lily_Maggio";

    (0, _nock2.default)('https://docker.mender.io/api/management/v1/devauth').get('/devices/count').query({
        status: status
    }).reply(200, {});
    mender.getAuthDevicesCount(status).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should deleteTokensById()', function (done) {
    var id = "Ivory35";

    (0, _nock2.default)('https://docker.mender.io/api/management/v1/devauth').delete('/tokens/' + id).query({}).reply(200, {});
    mender.deleteTokensById(id).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should getLimitsMaxAuthDevices()', function (done) {

    (0, _nock2.default)('https://docker.mender.io/api/management/v1/devauth').get('/limits/max_devices').query({}).reply(200, { limit: 500 });
    mender.getLimitsMaxAuthDevices().then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
