...
it('should addGroupDevice()', function (done) {
    ...
    mender.addGroupDevice(id).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should postDeployments()', function (done) {
    ...
    mender.postDeployments().then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should putDeploymentsByDeploymentIdStatus()', function (done) {
    ...
    mender.putDeploymentsByDeploymentIdStatus(deployment_id).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should postArtifacts()', function (done) {
    ...
    mender.postArtifacts().then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should putArtifactsById()', function (done) {
    ...
    mender.putArtifactsById(id).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should postDevices()', function (done) {
    ...
    mender.postDevices().then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should putDevicesById()', function (done) {
    ...
    mender.putDevicesById(id).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should putDevicesByIdStatus()', function (done) {
    ...
    mender.putDevicesByIdStatus(id).then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
...
it('should postUsers()', function (done) {
    ...
    mender.postUsers().then(function (res) {
        done();
    }, function (err) {
        console.error(err);
        done.fail(err);
