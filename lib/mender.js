...
var Mender = function () {
  function Mender() {
    var baseURL = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "https://docker.mender.io/api/management/v1";

    _classCallCheck(this, Mender);

    var _baseURLType = _flowRuntime2.default.string();

    _flowRuntime2.default.param('baseURL', _baseURLType).assert(baseURL);
