  ...
  * use the results to create and manage device groups for the purpose of deployment scheduling
  ...
  _createClass(Mender, [{
    ...
    value: function getDevicesPaging(page, per_page, sort, has_group) {
      ...
      // AxiosResponse is not in flowtyped yet
      var get = _flowRuntime2.default.annotate(function get(page, perPage, sort, hasGroup) {
        var attributes = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
        ...
        var _perPageType = _flowRuntime2.default.union(_flowRuntime2.default.void(), _flowRuntime2.default.nullable(_flowRuntime2.default.number()));
        ...
        var _hasGroupType = _flowRuntime2.default.union(_flowRuntime2.default.void(), _flowRuntime2.default.nullable(_flowRuntime2.default.boolean()));

        var _attributesType3 = _flowRuntime2.default.union(_flowRuntime2.default.void(), _flowRuntime2.default.nullable(_flowRuntime2.default.object()));
        ...
        _flowRuntime2.default.param('perPage', _perPageType).assert(perPage);

        _flowRuntime2.default.param('sort', _sortType3).assert(sort);

        _flowRuntime2.default.param('hasGroup', _hasGroupType).assert(hasGroup);
      ...
      }, _flowRuntime2.default.function(_flowRuntime2.default.param('page', _flowRuntime2.default.union(_flowRuntime2.default.void(), _flowRuntime2.default.nullable(_flowRuntime2.default.number()))), _flowRuntime2.default.param('perPage', _flowRuntime2.default.union(_flowRuntime2.default.void(), _flowRuntime2.default.nullable(_flowRuntime2.default.number()))), _flowRuntime2.default.param('sort', _flowRuntime2.default.union(_flowRuntime2.default.void(), _flowRuntime2.default.nullable(_flowRuntime2.default.string()))), _flowRuntime2.default.param('hasGroup', _flowRuntime2.default.union(_flowRuntime2.default.void(), _flowRuntime2.default.nullable(_flowRuntime2.default.boolean()))), _flowRuntime2.default.param('attributes', _flowRuntime2.default.union(_flowRuntime2.default.void(), _flowRuntime2.default.nullable(_flowRuntime2.default.object()))), _flowRuntime2.default.return(_flowRuntime2.default.ref('Promise', _flowRuntime2.default.any()))));

      var parseLink = require('parse-link-header');
      var qs = require('qs');

      var _page = page || 1; // for next page only if no next link
      return _returnType2.assert(_rxjs2.default.Observable.fromPromise(get(page, perPage, sort, hasGroup, attributes)).expand(function (res) {
        if (res.headers && res.headers.link) {
          var link = parseLink(res.headers.link);
          if (!link.next || !link.next.url) {
            return _rxjs2.default.Observable.empty();
          }
          var url = link.next.url.startsWith('http://') || link.next.url.startsWith('https://') ? link.next.url : '/inventory/' + link.next.url;
          ...
          _page += 1;
          return _rxjs2.default.Observable.fromPromise(get(_page, perPage, sort, hasGroup, attributes));
        }
      }).map(function (res) {
        return res.data;
      }).flatMap(function (it) {
    ...
    value: function postDeployments() {
      ...
      return this._axios.post('/deployments/deployments').then(function (res) {
        ...
        return _returnType27.assert(_arg26);
      });
    }
    ...
    value: function getDeploymentsById(id) {
      ...
      var _returnType28 = _flowRuntime2.default.return(Deployment);
      ...
      return this._axios.get('/deployments/deployments/' + id).then(function (res) {
        ...
        return _returnType28.assert(_arg27);
      });
    }
    ...
    value: function putDeploymentsByDeploymentIdStatus(deployment_id) {
      ...
      return this._axios.put('/deployments/deployments/' + deployment_id + '/status').then(function (res) {
        ...
        return _returnType29.assert(_arg28);
      });
    }
    ...
    value: function getDeploymentsByDeploymentIdStatistics(deployment_id) {
      ...
      var _returnType30 = _flowRuntime2.default.return(DeploymentStatistics);
      ...
      return this._axios.get('/deployments/deployments/' + deployment_id + '/statistics').then(function (res) {
        ...
        return _returnType30.assert(_arg29);
      });
    }
    ...
    value: function getDeploymentsByDeploymentIdDevices(deployment_id) {
      ...
      var _returnType31 = _flowRuntime2.default.return(DeploymentDevice);
      ...
      return this._axios.get('/deployments/deployments/' + deployment_id + '/devices').then(function (res) {
        ...
        return _returnType31.assert(_arg30);
      });
    }
    ...
    value: function getDeploymentsByDeploymentIdDevicesByDeviceIdLog(deployment_id, device_id) {
      ...
      var _returnType32 = _flowRuntime2.default.return(_flowRuntime2.default.any());
      ...
      return this._axios.get('/deployments/deployments/' + deployment_id + '/devices/' + device_id + '/log').then(function (res) {
        ...
        return _returnType32.assert(_arg31);
      });
    }
    ...
    value: function deleteDeploymentsDevicesById(id) {
      ...
      var _returnType33 = _flowRuntime2.default.return(_flowRuntime2.default.any());
      ...
      return this._axios.delete('/deployments/deployments/devices/' + id).then(function (res) {
        ...
        return _returnType33.assert(_arg32);
      });
    }
    ...
    value: function getDeploymentsReleases(name) {
      ...
      var _returnType34 = _flowRuntime2.default.return(Release);
      ...
      return this._axios.get('/deployments/deployments/releases', {
        ...
        return _returnType34.assert(_arg33);
      });
    }
    ...
    value: function getArtifacts() {
      ...
      return this._axios.get('/deployments/artifacts').then(function (res) {
        ...
        return _returnType35.assert(_arg34);
      });
    }
    ...
    value: function postArtifacts() {
      ...
      return this._axios.post('/deployments/artifacts').then(function (res) {
        ...
        return _returnType36.assert(_arg35);
      });
    }
    ...
    value: function getArtifactsById(id) {
      ...
      return this._axios.get('/deployments/artifacts/' + id).then(function (res) {
        ...
        return _returnType37.assert(_arg36);
      });
    }
    ...
    value: function putArtifactsById(id) {
      ...
      return this._axios.put('/deployments/artifacts/' + id).then(function (res) {
        ...
        return _returnType38.assert(_arg37);
      });
    }
    ...
    value: function deleteArtifactsById(id) {
      ...
      var _returnType39 = _flowRuntime2.default.return(_flowRuntime2.default.any());
      ...
      return this._axios.delete('/deployments/artifacts/' + id).then(function (res) {
        ...
        return _returnType39.assert(_arg38);
      });
    }
    ...
    value: function getArtifactsByIdDownload(id) {
      ...
      var _returnType40 = _flowRuntime2.default.return(ArtifactLink);
      ...
      return this._axios.get('/deployments/artifacts/' + id + '/download').then(function (res) {
        ...
        return _returnType40.assert(_arg39);
      });
    }
    ...
    value: function getLimitsStorage() {
      var _returnType41 = _flowRuntime2.default.return(StorageLimit);

      return this._axios.get('/deployments/limits/storage').then(function (res) {
        return res.data;
      }).then(function (_arg40) {
        return _returnType41.assert(_arg40);
      });
    }
  }]);
